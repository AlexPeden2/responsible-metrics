...
When engaging with research metrics it's important to focus on the question you are trying to answer, or the information you are trying to convey, so you can decide if using metrics will be useful and accurate, or not.
...
-   What metrics will be used? Can you apply these across your whole analysis or candidate pool?
    -   if you can't, you shouldn't use these metrics
-   Where did the data come from? When was the data extracted?
    -   data should come from the same sources on a similar date, particularly if you plan to compare any aspect.  Citations accrue all the time so different extraction dates can undermine comparison.
