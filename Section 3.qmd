...
-   guidance on how to use metrics responsibly in research assessment
-   an example question
...
First of all you need to think carefully about what it is you are trying to understand, what is the question you are trying to answer, then which information might help you to do that and where in an assessment process it would be most useful to request that from applicants.

Once you have established this, the next stage is to identify which type of information will help you make a decision.  You can ask people to provide this information in their application, and if you decide research metrics might be useful you can identify sources of data that could be helpful.
...
You may be asked to use a particular source to obtain your metrics, this might be so the requestor can ensure that the metrics they are collecting are as comparable as possible. Sometimes you might need to use a particular source because of the specific data available from that source or because of the functions that the source provides.
